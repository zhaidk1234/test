...
(function () {
	...
	THREE.TransformControls = function (camera, domElement) {
		...
		this.size = 1;
		this.axis = null;
		this.axisoption = null; //自定义参数，用于定义拖拽面
		...
		function onPointerHover(event) {
			...
			if (intersect) {
				...
				axis = scope.axisoption !=null? scope.axisoption:intersect.object.name;//自定义
		...
		function onPointerDown(event) {
			...
			if (pointer.button === 0 || pointer.button === undefined) {
				...
				if (intersect) {
					...
					scope.axis = scope.axisoption !=null? scope.axisoption:intersect.object.name;//自定义;
